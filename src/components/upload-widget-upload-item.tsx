...
export function UploadWidgetUploadItem({
	...
	return (
		<motion.div className="p-3 rounded-lg flex flex-col gap-3 shadow-card bg-white/[0.02] relative overflow-hidden">
			...
			>
				<Progress.Indicator
					className="bg-lime-500 h-1 group-data-[status=success]:bg-green-400 group-data-[status=error]:bg-red-400 group-data-[status=canceled]:bg-yellow-400 transition-all"
					style={{
